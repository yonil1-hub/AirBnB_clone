...
class TestBaseModel(unittest.TestCase):
    ...
    def test_id_check(self):
        ...
        self.assertEqual(self.b1.id, self.b1.id)

    def test_attr_check(self):
        """Checks for user created attributes"""

        self.b1.name = "kirubel"
        self.b2.name = "tadesse"
        self.assertEqual(self.b1.name, "kirubel")
        self.assertEqual(self.b2.name, "tadesse")
    ...
    def test_change_name(self):
        ...
        self.b1.name = "mery"
        self.b2.name = "kirubel"
        self.b1.name = "tadesse"
        self.assertTrue(self.b1.name, "tadesse")
        self.assertTrue(self.b2.name, "kirubel")
